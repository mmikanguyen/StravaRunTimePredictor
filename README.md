...
## Features
features.csv contains additional variables calculated for modeling: distance_km, total_time_min, pace_per_km, elevation_per_km, weekly_km, rolling_pace, hr_percent_max, effort_pace
